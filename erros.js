...
const variavel; // SyntaxError: Missing initializer in const declaration

// console.log(123 // SyntaxError: missing ) after argument list

console.log(variavelQueNaoExiste) // ReferenceError: variavelQueNaoExiste is not defined
...
// TypeError: Indica que o código esperava receber um dado de um determinado 
// tipo, tal qual uma string de texto, mas recebeu outro, como um número, 
// booleano ou null.
